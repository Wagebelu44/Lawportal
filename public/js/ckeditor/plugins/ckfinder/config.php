...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    //'baseUrl'      => 'http://'.$_SERVER['HTTP_HOST'].'/'.$url.'upload/ckfinder/userfiles',
    'baseUrl'      => 'http://billing.b3net.com/uploads/ckfinder/userfiles',
//    'baseUrl'      => realpath('../../../../../../../../upload/ckfinder/userfiles') ,
    'root'         => $_SERVER['DOCUMENT_ROOT'].'/uploads/ckfinder/userfiles', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0755,
    'chmodFolders' => 0755,
